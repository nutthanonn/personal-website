...
const CodeIcon: React.FC = () => {
  const IconComponent = [<CirleIcons />, <SunIcons />];
  return (
    <svg
    ...
    >
      ...
      <path
        fill="#2f2e41"
        d="M76.996 736.132L62.203 733.913 65.901 589.678 45.191 651.81 34.096 739.091 20.042 735.393 17.083 644.414 33.356 537.162 114.719 555.654 76.996 736.132z"
      ></path>
      <path
        fill="#2f2e41"
      ...
      ></path>
      <circle cx="109.542" cy="375.915" r="22.19" fill="#9f616a"></circle>
      <path
        fill="#9f616a"
      ...
      <path
        fill="#e6e6e6"
        d="M160.579 509.055L142.087 497.22 157.62 465.414 176.851 472.811 167.236 500.918 160.579 509.055z"
      ></path>
      <path
        fill="#3f3d56"
